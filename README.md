...
아래의 사용 예시를 모아 조판한 문서 [샘플](https://github.com/tonextpage/LaTeX-Documents/blob/43b46be03d7181becaad294163a61198c1aff1f8/sameple/sample.pdf)을 확인해보세요.
...
- **사용 예시** (연습문제 상자 안에 힌트 박스를 두 개 배치하였습니다.)
...
\b자
  ...
  \begin{hint}[보기] % [제목]을 [보기]로 입력한 힌트 상자
    \begin{itemize}
      \item[(현정)] 희수가 맞게 풀었네.
